    ...
    <div class="webform-progressbar-outer">
      ...
      <ol>
        <?php for ($n = 1; $n <= $page_count; $n++): ?>
          <li class="webform-progressbar-page<?php if ($n < $page_num) { print ' completed'; }; ?><?php if ($n == $page_num) { print ' current'; }; ?>" style="<?php print ($GLOBALS['language']->direction == 0) ? 'left' : 'right'; ?>: <?php print number_format(($n - 1) / ($page_count - 1), 4) * 100; ?>%">
