 ...
 */
function govcms_uikit_html_head_alter(&$head_elements) {
  // Mobile Viewport.
 ...
 */
function govcms_uikit_preprocess_html(&$variables) {
 ...
 */
function govcms_uikit_preprocess_field(&$variables) {
  if ($variables['element']['#field_name'] === 'field_slide_image') {
    // kpr($variables);
    $variables['items'][0]['#image_style'] = 'govcms_uikit_banner';
  }
}
 ...
 */
function govcms_uikit_image_styles_alter(&$styles) {
  $styles['govcms_uikit_banner'] = array(
    'label' => 'govCMS UI-KIT - Banner',
    'name' => 'govcms_uikit_banner',
